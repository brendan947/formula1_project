...
storage_account_name = "formula1dl100"
...
# MAGIC %md
# MAGIC ###example mounting azure container named presentation
# MAGIC ###mount_adls("presentation")
# MAGIC ###dbutils.fs.ls ("/mnt/formula1dl100/presentation")